...
#' factorial experiment, this matrix is typeically the treatment design matrix
#' associated with the interaction effects, because the interaction effects are
#' the smallest unit for the treatment effects.
#' 
...
#' also be contructed using this function.
#' 
...
#' @return A matrix where the rows corrospond to the observation and columns
#' corrospond to the overall combination of the treatment factors or the block
#' facotrs of the Phase 1 experiment.
#' @author Kevin Chang

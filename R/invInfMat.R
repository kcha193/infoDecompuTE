...
#' @param N a matrix representating the smallest unit of block or treatment
...
#' Orthogonal Block Structure. II. Treatment Structure and the General Analysis
#' of Variance." \emph{Proceedings of the Royal Society of London. Series A,

...
#' the Latex output.
#' 
#' Once the Latex script is generated, it requires the user to install and load
#' two Latex packages: \code{booktabs} and \code{bm} to complie the Latex
#' script.
#' 
#' @param ANOVA a matrix containing the coefficients of the variance components
#' in EMS of ANOVA table generated by \code{\link{getCoefVC.onePhase}} or
#' \code{\link{getCoefVC.twoPhase}}.

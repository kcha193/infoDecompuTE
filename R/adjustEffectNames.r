...
#' structual formula.
#' 
#' @param str a single string of characters containing the structural
...
#' 
#' adjustEffectNames(str, effectsMatrix, effectNames) 
#' 

adjustEffectNames = function(str, effectsMatrix, effectNames){

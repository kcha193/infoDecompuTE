...
#' \describe{
#'   \item{Blocks}{Block factor containing 6 levels}
#'   \item{Plots}{Plot factor containing 3 levels}
...
#'   \item{Blocks}{Block factor containing 6 levels}
#'   \item{Plots}{Plot factor containing 3 levels}
#'   \item{A}{Treatment factor A containing 2 levels}
#'   \item{B}{Treatment factor B containing 2 levels}
#'   \item{C}{Treatment factor C containing 3 levels}
#' }
"chrisEx2"
...
#' \describe{
#'   \item{Blocks}{Block factor containing 4 levels}
#'   \item{Plots}{Plot factor containing 2 levels}
#'   \item{A}{Treatment factor A containing 2 levels}
#'   \item{B}{Treatment factor B containing 2 levels}
#'   \item{C}{Treatment factor C containing 4 levels}
#' }
"chrisEx3"

...
#' 
#' Construct a list of orthogonal projector matrices corrosponding to all
...
#' \code{\link{makeBlkDesMat}} to projection matirces using
#' \code{\link{projMat}}. The second step is to use these projection matirces
#' to project the raw data vector from one stratum to next stratum of the
#' experiment; the resulting matrix corrosponds to each stratum is the
